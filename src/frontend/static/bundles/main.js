...
class BooksList extends React.Component {
    ...
    render() {
        console.log('DATA!');
        const bookNodes = this.state.data.map((book, index) => React.createElement(
            'li',
            { key: index },
            book.title
        ));
...
/* harmony export (immutable) */ __webpack_exports__["default"] = BooksList;


ReactDOM.render(React.createElement(BooksList, { url_api: '/api/', pollInterval: 1000 }), document.getElementById('container'));
